...
model_data_subtype <- model_days_new[which( substr(colnames(brca_cancer),1,12) %in% er_patients$bcr_patient_barcode ),]
...
for (l in gene_len){
  ...
  # write to file
  cox_random_file_subtype <- paste0("cox_random_results_subtype_er",l,".txt")
